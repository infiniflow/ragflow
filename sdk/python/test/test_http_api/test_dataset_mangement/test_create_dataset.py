...
class TestAdvancedConfigurations:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("naive_empty", "naive", {}, 0),
            pytest.param(
                "naive_chunk_token_count_negative",
                "naive",
                {"chunk_token_count": -1},
                102,
            ...
            (
                "knowledge_graph_entity_types_default",
                "knowledge_graph",
                {
                    "entity_types": [
                        "organization",
            ...
            pytest.param(
                "knowledge_graph_entity_types_not_list",
                "knowledge_graph",
