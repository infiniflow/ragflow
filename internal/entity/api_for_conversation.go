...
// API4Conversation API for conversation model. Message and Reference are
// hydrated from their ordered child tables.
type API4Conversation struct {
	...
	Reference    json.RawMessage `gorm:"-" json:"reference,omitempty"`
