...
func (g *GoogleModel) DLA(modelName *string, content []byte, apiConfig *APIConfig) (*DLAResponse, error) {
	return nil, fmt.Errorf("%s, no such method", g.Name())
}

func (g *GoogleModel) TSR(modelName *string, content []byte, apiConfig *APIConfig) (*TSRResponse, error) {
	return nil, fmt.Errorf("%s, no such method", g.Name())
}
