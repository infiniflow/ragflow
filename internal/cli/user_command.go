...
func (c *CLI) APIDropAgentCommand(cmd *Command) (ResponseIf, error) {
	...
	var result SimpleResponse
	if err = json.Unmarshal(resp.Body, &result); err != nil {
		return nil, fmt.Errorf("delete agent failed: invalid JSON (%w)", err)
	}
...
func (c *CLI) APIDropChatCommand(cmd *Command) (ResponseIf, error) {
	...
	var result SimpleResponse
	if err = json.Unmarshal(resp.Body, &result); err != nil {
		return nil, fmt.Errorf("delete chat failed: invalid JSON (%w)", err)
	}
...
func (c *CLI) APIDropSearchCommand(cmd *Command) (ResponseIf, error) {
	...
	var result SimpleResponse
	if err = json.Unmarshal(resp.Body, &result); err != nil {
		return nil, fmt.Errorf("delete search failed: invalid JSON (%w)", err)
	}
...
func (c *CLI) APIDropMemoryCommand(cmd *Command) (ResponseIf, error) {
	...
	var result SimpleResponse
	if err = json.Unmarshal(resp.Body, &result); err != nil {
		return nil, fmt.Errorf("delete memory failed: invalid JSON (%w)", err)
	}
