...
// state_serializer.go implements compose.Serializer interface for
// CanvasState. See plan §2.6 — the Serializer signature is
...
// JSON. calls this when persisting or restoring a checkpoint;
...
// (harness provides a fresh *checkpoint-like value).
