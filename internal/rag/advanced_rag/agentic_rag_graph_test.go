...
func TestRunSlotResearchPassLedgerRecordsSessionHint(t *testing.T) {
	...
	res := RunSlotResearchPass(context.Background(), context.Background(), deps, "who opened it?", st, 60, nil)
	if res == nil {
...
func TestRunSlotResearchPassLogsSlotEvidenceBound(t *testing.T) {
	...
	if res := RunSlotResearchPass(context.Background(), context.Background(), deps, "who opened it?", st, 60, nil); res == nil {
		t.Fatal("RunSlotResearchPass returned nil")
	}
...
func TestRunSlotResearchPassRunsTheDeclaredPatterns(t *testing.T) {
	...
	RunSlotResearchPass(context.Background(), context.Background(), deps, st.Question, st, 60, nil)
	...
	RunSlotResearchPass(context.Background(), context.Background(), deps, second.Question, second, 60, nil)
	if got := exec.ran(); got != want {
