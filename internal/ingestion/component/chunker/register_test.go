...
// TestNewChunkersRegistered pins that OneChunker, PairChunker, TableChunker
...
func TestNewChunkersRegistered(t *testing.T) {
	for _, name := range []string{ComponentNameOneChunker, ComponentNamePairChunker, ComponentNameTableChunker, ComponentNamePageChunker} {
