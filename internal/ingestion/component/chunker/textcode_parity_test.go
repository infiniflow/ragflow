...
// TextParser owns delimiter splitting, while TokenChunker owns the final
// token-budget merge. The Python golden is generated by the same TxtParser
// path used by parser._code; comparison follows the parser alignment contract
// and ignores representation-only chunk boundaries and whitespace.
