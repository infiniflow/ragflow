...
var builtinComponentParamsGolden = map[string]string{
	...
	"presentation":       "{\"File\": {}, \"Parser:HipSignsRhyme\": {\"pdf\": {\"flatten_media_to_text\": false, \"output_format\": \"json\", \"parse_method\": \"DeepDOC\", \"preprocess\": [\"main_content\"], \"suffix\": [\"pdf\"], \"vlm\": {}}, \"slides\": {\"output_format\": \"json\", \"parse_method\": \"DeepDOC\", \"preprocess\": [\"main_content\"], \"suffix\": [\"pptx\", \"ppt\"]}}, \"Tokenizer:TallTreesDance\": {\"fields\": \"text\", \"filename_embd_weight\": 0.1, \"search_method\": [\"embedding\", \"full_text\"]}, \"PresentationChunker:HappyHillsGlow\": {}, \"Extractor:AutoExtractDefault\": {\"field_name\": \"\", \"keywords\": {\"system_prompt\": \"\", \"top_n\": 0}, \"llm_id\": \"\", \"metadata\": {\"built_in_metadata\": [], \"enabled\": false, \"metadata\": []}, \"questions\": {\"system_prompt\": \"\", \"top_n\": 0}, \"summary\": {\"enabled\": false, \"system_prompt\": \"\"}, \"system_prompt\": \"\", \"tags\": {\"tag_file_id\": \"\", \"top_n\": 0}}}",
...
func TestBuiltInMetadataFromParserConfig_ModularMetadataShape(t *testing.T) {
	pc := entity.JSONMap{
		"Extractor:AutoExtractDefault": map[string]any{
	...
	cfg, enabled := builtInMetadataFromParserConfig(pc)
	if !enabled {
		t.Fatal("expected auto metadata enabled=true for modular metadata config")
	}
	if len(cfg) != 2 {
		t.Fatalf("built-in config len = %d, want 2", len(cfg))
	}
