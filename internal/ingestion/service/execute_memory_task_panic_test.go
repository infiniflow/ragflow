...
// TestHandleAndExecute_SurvivesMemoryPanicAndKeepsServing proves a recovered
// memory panic does not prevent the same worker from processing its next
// hand-off.
func TestHandleAndExecute_SurvivesMemoryPanicAndKeepsServing(t *testing.T) {
