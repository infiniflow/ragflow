...
func (f *fakeDocumentService) BatchUpdateDocumentMetadata(datasetID string, req *service.BatchUpdateMetadataRequest) (*service.BatchUpdateMetadataResult, error) {
	return nil, nil
}
