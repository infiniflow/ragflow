...
func (m *mockChunkSvc) ListChunksREST(datasetID, documentID, userID, id string, page, pageSize int, keywords string, available *bool) (*service.ListChunksResponse, error) {
	panic("not implemented")
}
...
func (m *mockChunkSvc) SwitchChunks(datasetID, documentID, userID string, chunkIDs []string, availableInt int) error {
	panic("not implemented")
}
