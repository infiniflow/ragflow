...
class MsgStoreConnection(ABC):
    ...
    @abstractmethod
    def indexExist(self, indexName: str, memoryId: str) -> bool:
        """
    ...
    @abstractmethod
    def get(self, messageId: str, indexName: str, memoryIds: list[str]) -> dict | None:
        """
    ...
    @abstractmethod
    def insert(self, rows: list[dict], indexName: str, memoryId: str = None) -> list[str]:
        """
