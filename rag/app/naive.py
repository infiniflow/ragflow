    ...
    if re.search(r"\.docx$", filename, re.IGNORECASE):
        ...
        if table_context_size or image_context_size:
            tables = append_context2table_image4pdf(
                ...
                tables,
                image_context_size,
                section_page_offset=from_page if name in {"mineru", "monkeyocr", "monkeyocrv2"} else 0,
            )

        if name in ["tcadp", "docling", "mineru", "monkeyocr", "monkeyocrv2", "paddleocr", "opendataloader", "somark", "mistral ocr"]:
