    ...
    async def search(self, req, idx_names: str | list[str], kb_ids: list[str], emb_mdl=None, highlight: bool | list | None = None, rank_feature: dict | None = None, min_match: bool = True):
        ...
        if not qst:
            ...
            if emb_mdl is None:
                ...
                if settings.DOC_ENGINE_OCEANBASE or settings.DOC_ENGINE_SERENEDB or settings.DOC_ENGINE_VASTBASE:
    ...
    async def retrieval(
        ...
        if rerank_mdl and sres.total > 0:
            ...
            if settings.DOC_ENGINE_INFINITY:
                ...
                tsim = sim
                vsim = sim
            elif settings.DOC_ENGINE_OCEANBASE or settings.DOC_ENGINE_SERENEDB or settings.DOC_ENGINE_VASTBASE:
