...
class RAGFlowAzureSasBlob:
    def __init__(self):
        self.conn = None
        self.container_url = os.getenv('CONTAINER_URL', app_config.storage.azure_sas.container_url)
        self.sas_token = os.getenv('SAS_TOKEN', app_config.storage.azure_sas.sas_token)
        self.__open__()
