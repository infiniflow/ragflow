...
def filename_type(filename):
    ...
    if re.match(r".*\.(msg|eml|doc|docx|ppt|pptx|yml|yaml|xml|htm|json|jsonl|ldjson|csv|txt|ini|xls|xlsx|wps|rtf|hlp|pages|numbers|key|md|mdx|py|js|java|c|cpp|h|php|go|ts|sh|cs|kt|html|sql)$", filename):
