...
class ParserConfig(Base):
    ...
    layout_recognize_auto_text: Annotated[str | None, Field(default=None)]
    layout_recognize_auto_scanned: Annotated[str | None, Field(default=None)]
    layout_recognize_auto_min_chars_per_page: Annotated[int | None, Field(default=None, ge=1)]
