...
def add_chunk(tenant_id, dataset_id, document_id):
    ...
    _, insert_count = settings.docStoreConn.insert([d], search.index_name(tenant_id), dataset_id)

    DocumentService.increment_chunk_num(doc.id, doc.kb_id, c, insert_count, 0)
    # rename keys
    key_mapping = {
        "id": "id",
