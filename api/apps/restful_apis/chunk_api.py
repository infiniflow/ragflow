...
from api.utils.pagination_utils import validate_rest_api_page, validate_rest_api_page_size
...
async def retrieval_test(tenant_id):
    ...
    page = validate_rest_api_page(req.get("page", 1))
    size = validate_rest_api_page_size(req.get("page_size", 30))
