...
async def list_chunk():
    ...
    try:
        ...
        sres = providers.retriever.conn.search(
...
async def retrieval_test():
    ...
    async def _retrieval():
        ...
        ranks = providers.retriever.conn.retrieval(_question, embd_mdl, tenant_ids, kb_ids, page, size,
...
def knowledge_graph():
    ...
    sres = providers.retriever.conn.search(req, search.index_name(tenant_id), kb_ids)
    obj = {"graph": {}, "mind_map": {}}
