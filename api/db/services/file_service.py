    ...
    def upload_document(self, kb, file_objs, user_id):
        ...
        for file in file_objs:
            try:
                ...
                from settings import MAX_FILE_NAME_BYTES_LENGTH
                if len(file.filename.encode("utf-8")) >= MAX_FILE_NAME_BYTES_LENGTH:
                    msg = "Exceed the maximum length of file name! Limit:" + MAX_FILE_NAME_BYTES_LENGTH
