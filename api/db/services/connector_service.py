...
def _gaussdb_append_text_expr(field, suffix: str):
...
class SyncLogsService(CommonService):
        ...
        try:
            ...
            if task:
                if _is_gaussdb_compatible_metadata_db():
                    ...
                    error_msg_expr = _gaussdb_append_text_expr(cls.model.error_msg, str(e))
                    trace_expr = _gaussdb_append_text_expr(cls.model.full_exception_trace, str(e))
    ...
    def increase_docs(cls, id, max_update, doc_num, err_msg="", error_count=0):
        ...
        if _is_gaussdb_compatible_metadata_db():
            ...
            error_msg_expr = _gaussdb_append_text_expr(cls.model.error_msg, err_msg)
            if error_msg_expr is not None:
                update_payload["error_msg"] = error_msg_expr
