    ...
    def lock(self):
        ...
        while True:
            ...
            if elapsed >= self.timeout:
                raise TimeoutError(f"acquire postgres lock {self.lock_name} timeout after {elapsed:.2f}s: lock is held by another session")
            ...
            if sleep_time > 0:
                ...
                raise TimeoutError(f"acquire postgres lock {self.lock_name} timeout: lock is held by another session")
