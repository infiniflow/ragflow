...
class UserCanvas(DataBaseModel):
    ...
    catalog = CharField(max_length=16, null=False, help_text="catalog", index=True)
    is_virtual = BooleanField(null=False, help_text="catalog", default=False, index=True)
    dsl = JSONField(null=True, default={})
...
class Department(DataBaseModel):
    ...
    parent_id = CharField(max_length=32, null=True, help_text="上级部门ID", index=True)
    status = CharField(max_length=1, null=True, help_text="is it validate(0: wasted, 1: validate)", default="1", index=True)
...
class Group(DataBaseModel):
    id = CharField(max_length=32, primary_key=True)
    tenant_id = CharField(max_length=32, null=False, index=True)
    name = CharField(max_length=100, null=False, help_text="群组名称", index=True)
