...
export default {
  ...
  get_risk_identify_template: `${api_host}/kb/risk_identify/template`,
  ...
  risk_ai_identify_task_download: `${api_host}/kb/risk_ai_identify_task/download`,
  risk_ai_identify_task_retry_failed: `${api_host}/kb/risk_ai_identify_task/retry_failed`,
  risk_ai_identify_task_list: `${api_host}/kb/risk_ai_identify_task/list`,
