  ...
  translation: {
    ...
    knowledgeDetails: {
      ...
      similarityThresholdTip:
        'يستخدم RAGFlow أثناء الاسترجاع إما مزيجًا من تشابه الكلمات الرئيسية الموزون وتشابه جيب التمام المتجهي الموزون، أو مزيجًا من تشابه الكلمات الرئيسية الموزون ودرجة إعادة الترتيب الموزونة عند اختيار نموذج لإعادة الترتيب. تحدد هذه المعلمة عتبة التشابه بين استعلام المستخدم والمقاطع. سيتم استبعاد أي مقطع تقل درجة تشابهه عن هذه العتبة من النتائج. افتراضيًا، تُضبط العتبة على 20، ما يعني أنه لن يتم استرداد سوى المقاطع التي تبلغ درجة التشابه الهجين لها 20 أو أكثر. إذا ضُبط وزن تشابه المتجهات على 0، فلا تنطبق هذه العتبة.',
      vectorSimilarityWeight: 'ناقل تشابه الوزن',
      vectorSimilarityWeightTip:
        'يحدد هذا وزن تشابه المتجهات في درجة التشابه المجمعة، سواء استُخدم مع تشابه جيب التمام المتجهي أو مع درجة إعادة الترتيب. يجب أن يساوي مجموع الوزنين 1.0.',
      keywordSimilarityWeight: 'وزن تشابه الكلمات الرئيسية',
      keywordSimilarityWeightTip:
        'يحدد هذا وزن تشابه الكلمات الرئيسية في درجة التشابه المجمعة. يجب أن يساوي مجموع وزني المتجهات والكلمات الرئيسية 1.0.',
    ...
    knowledgeConfiguration: {
      ...
      useRaptor: 'رابتور',
      useRaptorTip:
        'يمكن استخدام RAPTOR لمهام الإجابة على الأسئلة متعددة القفزات. انتقل إلى صفحة الملفات، وانقر فوق إنشاء > RAPTOR لتمكينه. راجع https://ragflow.io/docs/knowledge_compilation/built_in_templates_and_dedicated_configuration#tree للحصول على التفاصيل.',
      prompt: 'اِسْتَدْعَى',
      promptTip:
      ...
      useGraphRagTip:
        'قم بإنشاء رسم بياني معرفي على أجزاء ملف من قاعدة المعرفة الحالية لتحسين الإجابة على الأسئلة متعددة القفزات التي تتضمن منطقًا متداخلاً. راجع https://ragflow.io/docs/knowledge_compilation/built_in_templates_and_dedicated_configuration#graph للحصول على التفاصيل.',
    ...
    chat: {
      ...
      webSearchApiKeyHelp: 'كيفية الحصول عليه؟',
