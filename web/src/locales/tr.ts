...
<ul>
  ...
  <li>Otomatik anahtar kelime özelliği LLM'e bağımlıdır ve önemli miktarda token tüketir.</li>
      ...
      Spacy: Varlıkları ve ilişkileri çıkarmak için spaCy NER ve kural tabanlı anahtar kelime çıkarma kullanılır. Çıkarma işlemi için LLM gerekmez, bu da onu hızlı ve kaynak verimli yapar.`,
...
**Temel Kurallar:**
  ...
  - **Her zaman** konuşma geçmişinin tamamını göz önünde bulundurun.`,
      ...
      **Temel Kurallar:**
      ...
      variable: 'Değişken',
      variableTip: `RAGFlow'un sohbet asistanı yönetim API'leri ile birlikte kullanılır.`,
      add: 'Ekle',
      key: 'Anahtar',
