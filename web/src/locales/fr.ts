...
**Règles essentielles :**
  ...
  - **Tenez toujours compte** de l'historique complet de la conversation.`,
    ...
    setting: {
      ...
      monkeyocrBackend: 'Backend MonkeyOCR',
      monkeyocrBackendMessage: 'Veuillez sélectionner le backend MonkeyOCR !',
      monkeyocrSelectBackend: 'Sélectionner le backend de traitement',
      monkeyocrDeleteOutput: 'Supprimer les fichiers de sortie après l’analyse',
      modify: 'Modifier',
