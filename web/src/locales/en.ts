export default {
  translation: {
    ...
    skills: {
      title: 'Skills',
      selectHub: 'Select a Skills Hub to get started',
      hubPlaceholder: 'Enter hub name',
      createHub: 'Create Skills Hub',
      createHubTitle: 'Create New Skills Hub',
      createHubDescription:
        'Create a new hub to organize and manage your skills.',
      hubName: 'Hub Name',
      hubNamePlaceholder: 'e.g., my-hub',
      hubNameRequired: 'Please enter hub name',
...
[Insert text here]`,
    ...
    empty: {
      ...
      skillsTitle: 'No skills hub created yet',
      notFoundSkills: 'Skills hub not found',
      addNow: 'Add Now',
    },
