...
Example: Virtual Hosted Style`,
      ...
      monkeyocrApiserver: 'MonkeyOCR API Server',
      monkeyocrApiserverMessage: 'Please input the MonkeyOCR API Server URL!',
      monkeyocrApiserverPlaceholder: 'e.g. http://host.docker.internal:9000',
      monkeyocrServerUrl: 'MonkeyOCR vLLM Server URL',
      monkeyocrServerUrlMessage: 'Please input the MonkeyOCR vLLM Server URL!',
      monkeyocrServerUrlPlaceholder: 'e.g. http://your-vllm-server:8888',
      monkeyocrOutputDir: 'MonkeyOCR Output Directory',
      monkeyocrOutputDirPlaceholder: '/tmp/monkeyocr',
      monkeyocrBackend: 'MonkeyOCR Backend',
      monkeyocrBackendMessage: 'Please select the MonkeyOCR backend!',
      monkeyocrSelectBackend: 'Select processing backend',
      monkeyocrDeleteOutput: 'Delete output files after parsing',
      modify: 'Modify',
