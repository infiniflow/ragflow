...
Example: Virtual Hosted Style`,
      ...
      mineru: {
        ...
        officialBaseUrlRequired: 'MinerU official API base URL is required',
        officialTokenRequired: 'MinerU official API token is required',
        serverUrlBackendLimit:
          'MinerU Server URL Address is only available for the HTTP client backend',
        accessMode: 'MinerU access mode',
        accessModeSelfHosted: 'Self-hosted MinerU service',
        accessModeOfficialV4: 'MinerU official v4 API',
        selectAccessMode: 'Select access mode',
        ...
        officialBaseUrl: 'Official API base URL',
        officialToken: 'Official API token',
        officialModelVersion: 'Official model version',
        selectModelVersion: 'Select model version',
        officialPollInterval: 'Polling interval (seconds)',
        officialPollTimeout: 'Polling timeout (seconds)',
