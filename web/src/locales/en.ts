...
**Essential Rules:**
  ...
  - **Always consider** the entire conversation history.`,
      ...
      **Essential Rules:**
      ...
      maxTokensMessage: 'Context length is required',
      maxTokensTip: `The maximum context size of the model; an invalid or incorrect value will cause an error. Defaults to 512.`,
      maxTokensInvalidMessage: 'Please enter a valid number for Context length.',
      maxTokensMinMessage: 'Context length cannot be less than 0.',
      thinking: 'Thinking',
...
Example: Virtual Hosted Style`,
      ...
      modelMaxTokensMessage: 'Context length must be a number',
      modelMaxTokensMinMessage: 'Context length must be at least 0',
    },
