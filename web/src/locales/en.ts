...
[Insert text here]`,
    ...
    knowledgeCompilation: {
      ...
      exampleLabel: 'Page-structure example',
      examplePlaceholder: 'Describe how an artifact page should be structured…',
      exampleDescription:
        'Overrides the page-structure section of the writer prompt. Leave empty to fall back to the built-in default.',
      treeSectionTitle: 'RAPTOR tree settings',
      treePromptLabel: 'Summarization prompt',
      treePromptPlaceholder:
