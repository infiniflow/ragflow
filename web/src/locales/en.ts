export default {
  translation: {
    ...
    evaluation: {
      ...
      datasetNamePlaceholder: 'e.g. Support FAQ regression',
      name: 'Name',
      ...
      testCasesDescription:
        'Add questions and optional ground-truth answers or chunk ids for retrieval metrics.',
      addCase: 'Add case',
      importCsv: 'Import CSV',
      importSuccess: 'Imported {{count}} test case(s)',
      question: 'Question',
      referenceAnswer: 'Reference answer',
      relevantChunkIds: 'Relevant chunk ids',
      chunkIdsPlaceholder: 'Comma-separated chunk ids (optional)',
      noCases: 'No test cases yet. Add or import cases to run evaluation.',
      runs: 'Runs',
      runsDescription: 'Past evaluation runs against a chat assistant.',
      noRuns: 'No runs yet.',
      runEvaluation: 'Run evaluation',
      selectChat: 'Chat assistant',
      selectChatPlaceholder: 'Select a chat assistant',
      startRun: 'Start run',
