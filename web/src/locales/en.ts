...
The above is the content you need to summarize.`,
      ...
      tagSet: 'Tag set',
      tagSetTip: `
     <p> Select one or multiple tag knowledge bases to auto-tag all chunks in your knowledge base. </p>
<p>Query to those chunks will also be with tags.</p>
...
<ul>
  <li>Tag is a close set, which is predefined and manipulated by user while keyword is an open set.</li>
  <li>You need to upload tag sets in specified formats before referencing them.</li>
