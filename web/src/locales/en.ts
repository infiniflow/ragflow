  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    chat: {
      ...
      **Essential Rules:**
      ...
      maxTokensTip: `The maximum input context length of the model. Text exceeding this limit will be truncated before being sent to the model. Defaults to 8192.`,
