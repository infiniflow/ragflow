  ...
  - **Always consider** the entire conversation history.`,
      ...
      **Essential Rules:**
      ...
      temporalRetrieval: {
        ...
        description:
          'Use document metadata dates to filter or rerank time-sensitive retrieval.',
        modeLabel: 'Temporal mode',
        modeTip:
          'Auto only applies freshness when the query asks for recent or dated information.',
        modeAuto: 'Auto',
        modeLatest: 'Latest',
        modeDateRange: 'Date range',
        modeBalanced: 'Balanced',
        fieldLabel: 'Temporal field',
        fieldTip:
          'Select the source metadata field that represents publication or event time.',
        halfLifeLabel: 'Half-life days',
        halfLifeTip: 'Freshness boost decays by half over this many days.',
        detectedFormat: 'Detected format: {{format}}',
        parsedRate: 'Parsed: {{rate}}%',
        dateRange: 'Range: {{oldest}} to {{newest}}',
        hardFilterSupported: 'Hard filter: supported',
        hardFilterUnsupported: 'Hard filter: not supported',
        noProfile: 'No temporal profile available for this field.',
        profileError: 'Failed to load temporal profile for this field.',
