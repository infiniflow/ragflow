export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      uploadDescription:
        'RAGFlow hỗ trợ tải lên tệp một lần hoặc theo lô. Triển khai tại chỗ: Giới hạn tải lên tệp đơn là 1GB, với giới hạn tải lên theo lô là 32 tệp, và không có giới hạn về tổng số tệp trên mỗi tài khoản.',
      chunk: 'Khối',
      bulk: 'Hàng loạt',
      cancel: 'Hủy bỏ',
