export default {
    translation: {
      ...
      knowledgeDetails: {
        ...
        taskPageSizeMessage: '¡Por favor ingresa el tamaño de la tarea por página!',
        ...
        greaterThanPrevious:
          'El valor actual debe ser mayor que el anterior.',
      ...
      setting: {
        ...
        modelDescription: 'Configura el parámetro del modelo y la clave API aquí.',
        team: 'Equipo',
        system: 'Sistema',
        logout: 'Cerrar sesión',
        api: 'API',
        ...
        emailDescription: 'Una vez registrado, no se puede cambiar el correo electrónico.',
        ...
        newPasswordDescription: 'Tu nueva contraseña debe tener más de 8 caracteres.',
        confirmPassword: 'Confirmar nueva contraseña',
        confirmPasswordMessage: '¡Por favor confirma tu nueva contraseña!',
        confirmPasswordNonMatchMessage: '¡Las contraseñas que ingresaste no coinciden!',
        cancel: 'Cancelar',
        addedModels: 'Modelos agregados',
        modelsToBeAdded: 'Modelos a agregar',
        addTheModel: 'Agregar el modelo',
        apiKey: 'Clave API',
        apiKeyMessage: 'Por favor ingresa la clave API (ignora esto si el modelo está implementado localmente).',
        apiKeyTip: 'La clave API puede obtenerse registrándose con el proveedor correspondiente de LLM.',
        ...
        chatModelTip: 'El modelo LLM de chat predeterminado que todas las nuevas bases de conocimiento utilizarán.',
        embeddingModel: 'Modelo de embeddings',
        embeddingModelTip: 'El modelo de embeddings predeterminado que todas las nuevas bases de conocimiento utilizarán.',
        img2txtModel: 'Modelo de img2txt',
        img2txtModelTip: 'El modelo multimódulo predeterminado que todas las nuevas bases de conocimiento utilizarán. Puede describir una imagen o video.',
        sequence2txtModel: 'Modelo de secuencia a texto',
        sequence2txtModelTip: 'El modelo ASR predeterminado que todas las nuevas bases de conocimiento utilizarán. Usa este modelo para transcribir voces a texto correspondiente.',
        rerankModel: 'Modelo de reordenamiento',
        rerankModelTip: 'El modelo de reordenamiento predeterminado que se usará para reordenar los fragmentos recuperados por las preguntas de los usuarios.',
        ttsModel: 'Modelo TTS',
        ttsModelTip: 'El modelo TTS predeterminado que se usará para generar discurso durante las conversaciones cuando se solicite.',
        ...
        addFishAudioRefIDMessage: '¡Por favor ingresa el ID de Referencia (deja en blanco para usar el modelo predeterminado)!',
      ...
      message: {
        ...
        networkAnomalyDescription: 'Hay una anomalía en tu red y no puedes conectarte al servidor.',
      ...
      fileManager: {
        ...
        uploadDescription: 'Soporte para una sola carga o carga múltiple. Está estrictamente prohibido subir datos de la empresa u otros archivos prohibidos.',
        local: 'Subidas locales',
        s3: 'Subidas a S3',
        preview: 'Vista previa',
        fileError: 'Error en el archivo',
        uploadLimit: 'El tamaño del archivo no puede exceder los 10 MB, y el número total de archivos no puede exceder los 128',
      ...
      flow: {
        ...
        loop: 'Bucle',
        loopTip: 'El bucle es el límite superior del número de iteraciones del componente actual. Si el número de bucles supera este valor, significa que el componente no puede completar la tarea actual, por favor optimiza el agente nuevamente.',
        yes: 'Sí',
        no: 'No',
        key: 'Clave',
        ...
        answerDescription: 'Un componente que sirve como interfaz entre el humano y el bot, recibiendo las entradas del usuario y mostrando las respuestas del agente.',
        retrievalDescription: 'Un componente que recupera información de una base de conocimiento especificada y devuelve "Respuesta vacía" si no se encuentra información. Asegúrate de seleccionar la base de conocimiento correcta.',
        generateDescription: 'Un componente que solicita al LLM generar respuestas. Asegúrate de que el prompt esté configurado correctamente.',
        categorizeDescription: 'Un componente que utiliza el LLM para clasificar las entradas del usuario en categorías predefinidas. Asegúrate de especificar el nombre, descripción y ejemplos para cada categoría, junto con el componente siguiente correspondiente.',
        relevantDescription: 'Un componente que usa el LLM para evaluar si la salida previa es relevante para la última consulta del usuario. Asegúrate de especificar el próximo componente para cada resultado.',
        rewriteQuestionDescription: 'Un componente que refina una consulta del usuario si no se logra recuperar información relevante de la base de conocimiento. Repite este proceso hasta que se alcance el límite superior de iteraciones. Asegúrate de que su entrada provenga de "Relevante" y su salida se dirija a "Recuperación".',
        messageDescription: 'Un componente que envía un mensaje estático. Si se suministran múltiples mensajes, selecciona uno al azar para enviar. Asegúrate de que su salida sea "Responder", el componente de interfaz.',
        keywordDescription: 'Un componente que recupera los N resultados principales de búsqueda de la entrada del usuario. Asegúrate de que el valor de TopN esté configurado correctamente antes de su uso.',
        switchDescription: 'Un componente que evalúa condiciones basadas en la salida de componentes previos y dirige el flujo de ejecución en consecuencia. Permite lógica de ramificación compleja al definir casos y especificar acciones para cada caso o acción predeterminada si no se cumplen las condiciones.',
        wikipediaDescription: 'Este componente se usa para obtener resultados de búsqueda de wikipedia.org. Típicamente, actúa como un complemento a las bases de conocimiento. Top N especifica el número de resultados de búsqueda que necesitas ajustar.',
        promptText: 'Por favor resume los siguientes párrafos. Ten cuidado con los números, no inventes datos. Los párrafos son los siguientes: {input} El contenido anterior es el que necesitas resumir.',
        ...
        keywordExtractDescription: 'Un componente que extrae palabras clave de la consulta del usuario, con Top N especificando el número de palabras clave a extraer.',
        baidu: 'Baidu',
        baiduDescription: 'Este componente se usa para obtener resultados de búsqueda de www.baidu.com. Típicamente, actúa como un complemento a las bases de conocimiento. Top N especifica el número de resultados de búsqueda que necesitas ajustar.',
        duckDuckGo: 'DuckDuckGo',
        duckDuckGoDescription: 'Un componente que recupera resultados de búsqueda de duckduckgo.com, con TopN especificando el número de resultados de búsqueda. Complementa las bases de conocimiento existentes.',
        channel: 'Canal',
        channelTip: 'Realizar búsqueda de texto o búsqueda de noticias en la entrada del componente.',
        text: 'Texto',
        news: 'Noticias',
        messageHistoryWindowSize: 'Tamaño de la ventana del historial de mensajes',
        messageHistoryWindowSizeTip: 'El tamaño de ventana del historial de conversación que necesita ser visto por el LLM. Cuanto más grande mejor, pero ten cuidado con la longitud máxima de contenido que puede manejar el LLM.',
        wikipedia: 'Wikipedia',
        pubMed: 'PubMed',
        email: 'Correo electrónico',
        emailTip: 'Este componente se usa para obtener resultados de búsqueda de https://pubmed.ncbi.nlm.nih.gov/. Típicamente, actúa como un complemento a las bases de conocimiento. Top N especifica el número de resultados de búsqueda que necesitas ajustar. El correo electrónico es un campo obligatorio.',
        arXiv: 'ArXiv',
        arXivTip: 'Este componente se usa para obtener resultados de búsqueda de https://arxiv.org/. Típicamente, actúa como un complemento a las bases de conocimiento. Top N especifica el número de resultados de búsqueda que necesitas ajustar.',
        sortBy: 'Ordenar por',
        submittedDate: 'Fecha de envío',
        lastUpdatedDate: 'Última fecha de actualización',
        relevance: 'Relevancia',
        google: 'Google',
        googleTip: 'Este componente se usa para obtener resultados de búsqueda de https://www.google.com/. Típicamente, actúa como un complemento a las bases de conocimiento. Top N y la clave de API de SerpApi especifican el número de resultados de búsqueda que necesitas ajustar.',
        bing: 'Bing',
        bingTip: 'Este componente se usa para obtener resultados de búsqueda de https://www.bing.com/. Típicamente, actúa como un complemento a las bases de conocimiento. Top N y la clave de suscripción de Bing especifican el número de resultados de búsqueda que necesitas ajustar.',
        apiKey: 'Clave API',
        country: 'País',
        language: 'Idioma',
        googleScholar: 'Google Scholar',
        googleScholarDescription: 'Este componente se usa para obtener resultados de búsqueda de https://scholar.google.com/. Típicamente, actúa como un complemento a las bases de conocimiento. Top N especifica el número de resultados de búsqueda que necesitas ajustar.',
        yearLow: 'Año mínimo',
        yearHigh: 'Año máximo',
        patents: 'Patentes',
        data: 'Datos',
        deepL: 'DeepL',
        deepLDescription: 'Este componente se usa para obtener traducciones de https://www.deepl.com/. Típicamente, proporciona un resultado de traducción más especializado.',
        authKey: 'Clave de autenticación',
        sourceLang: 'Idioma fuente',
        targetLang: 'Idioma objetivo',
        gitHub: 'GitHub',
        githubDescription: 'Este componente se usa para buscar en el repositorio de https://github.com/. Top N especifica el número de resultados de búsqueda a ajustar.',
        baiduFanyi: 'BaiduFanyi',
        baiduFanyiDescription: 'Este componente se usa para obtener traducciones de https://fanyi.baidu.com/. Típicamente, proporciona un resultado de traducción más especializado.',
        ...
        qWeather: 'QWeather',
        qWeatherDescription: 'Este componente se usa para obtener información meteorológica de https://www.qweather.com/. Puedes obtener pronósticos meteorológicos, índices y calidad del aire.',
        lang: 'Idioma',
        type: 'Tipo',
        ...
        publish: 'API',
        exeSQL: 'ExeSQL',
        exeSQLDescription: 'El componente consulta los resultados de la base de datos relacional correspondiente mediante sentencias SQL. Soporta MySQL, PostgreSQL, MariaDB.',
        ...
        wenCaiDescription: 'El componente se puede utilizar para obtener información en una amplia gama de áreas financieras, incluidas, entre otras, acciones, fondos, etc.',
        ...
        akShare: 'AkShare',
        akShareDescription: 'Este componente se puede usar para obtener información de noticias para la acción correspondiente del sitio web de Eastmoney.',
        yahooFinance: 'YahooFinance',
        yahooFinanceDescription: 'El componente consulta información sobre la empresa en función del símbolo bursátil proporcionado.',
        info: 'Información',
        history: 'Historial',
        financials: 'Finanzas',
        ...
        jin10: 'Jin10',
        jin10Description: 'Este componente se puede utilizar para acceder a información del sector financiero desde la plataforma abierta Jin10, incluidos noticias rápidas, calendario, cotizaciones, referencias.',
        ...
        concentratorDescription: 'Un componente que recibe la salida del componente anterior y la pasa como entrada a los componentes posteriores.',
        tuShare: 'TuShare',
        tuShareDescription: 'Este componente se puede usar para obtener breves noticias financieras de sitios web financieros de referencia, lo que ayuda a la investigación industrial y cuantitativa.',
        tuShareSrcOptions: {
          sina: 'Sina',
