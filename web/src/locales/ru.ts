...
<ul>
  ...
  <li>Авто-ключевые слова зависят от LLM и потребляют много токенов.</li>
      ...
      Spacy: Использует spaCy NER и извлечение ключевых слов на основе правил для извлечения сущностей и связей. LLM не требуется для самого извлечения, что делает его быстрым и эффективным.`,
