...
Пример: Virtual Hosted Style`,
    ...
    flow: {
      ...
      emitAll: 'Показывать все блоки сообщения',
      emitAllTip: 'При включении каждый блок сообщения в этом компоненте выводится последовательно отдельным сообщением; при выключении выбирается один случайный блок.',
      thinking: 'Статус «думает»',
      thinkingTip: 'При включении это сообщение показывается как живой индикатор «думает», пока агент работает, и заменяется следующим сообщением, а не выдаётся как финальный ответ.',
      ...
      toolTimeoutTip: 'Таймаут в секундах для одного вызова инструмента (включая MCP). Увеличьте для длительно выполняющихся инструментов.',
      advancedSettings: 'Расширенные настройки',
