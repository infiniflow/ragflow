export default {
  translation: {
    ...
    login: {
      ...
      ldapTitle: 'Войти через {{provider}}',
      ldapDescription:
        'Используйте учётные данные каталога для входа.',
      cancel: 'Отмена',
      passwordEncryptFailed:
        'Не удалось зашифровать пароль. Пожалуйста, перезагрузите страницу и попробуйте снова.',
    },
    header: {
