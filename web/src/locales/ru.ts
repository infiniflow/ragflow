...
Пример: сообщение 1 КБ с эмбеддингом 1024 измерений — около 9 КБ. Лимит по умолчанию 5 МБ — примерно 500 таких сообщений.`,
    ...
    knowledgeDetails: {
      ...
      similarityThresholdTip:
        'При извлечении RAGFlow использует либо комбинацию взвешенного сходства по ключевым словам и взвешенного косинусного сходства векторов, либо, если выбрана модель реранжирования, комбинацию взвешенного сходства по ключевым словам и взвешенной оценки реранжирования. Этот параметр задает порог сходства между пользовательским запросом и чанками. Любой чанк с оценкой сходства ниже этого порога будет исключен из результатов. По умолчанию порог установлен на 20. Это означает, что будут извлекаться только чанки с оценкой гибридного сходства 20 или выше. Если вес векторного сходства установлен на 0, этот порог не применяется.',
      vectorSimilarityWeight: 'Вес векторной схожести',
      vectorSimilarityWeightTip:
        'Задает вес векторного сходства в комбинированной оценке сходства, используемый либо с косинусным сходством векторов, либо с оценкой реранжирования. Сумма двух весов должна быть равна 1.0.',
      keywordSimilarityWeight: 'Вес схожести по ключевым словам',
      keywordSimilarityWeightTip:
        'Задает вес сходства по ключевым словам в комбинированной оценке сходства. Сумма весов векторного сходства и сходства по ключевым словам должна быть равна 1.0.',
