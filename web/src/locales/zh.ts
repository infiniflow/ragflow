...
示例：general/v2/`,
      ...
      monkeyocrApiserver: 'MonkeyOCR API 服务器',
      monkeyocrApiserverMessage: '请输入 MonkeyOCR API 服务器地址！',
      monkeyocrApiserverPlaceholder: '例如：http://host.docker.internal:9000',
      monkeyocrServerUrl: 'MonkeyOCR vLLM 服务器 URL',
      monkeyocrServerUrlMessage: '请输入 MonkeyOCR vLLM 服务器 URL！',
      monkeyocrServerUrlPlaceholder: '例如：http://your-vllm-server:8888',
      monkeyocrOutputDir: 'MonkeyOCR 输出目录',
      monkeyocrOutputDirPlaceholder: '/tmp/monkeyocr',
      monkeyocrBackend: 'MonkeyOCR 后端',
      monkeyocrBackendMessage: '请选择 MonkeyOCR 后端！',
      monkeyocrSelectBackend: '选择处理后端',
      monkeyocrDeleteOutput: '解析后删除输出文件',
      modify: '修改',
