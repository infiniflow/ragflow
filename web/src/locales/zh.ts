...
示例：general/v2/`,
      ...
      mineru: {
        ...
        officialBaseUrlRequired: 'MinerU 官方 API Base URL 为必填项',
        officialTokenRequired: 'MinerU 官方 API Token 为必填项',
        serverUrlBackendLimit: '仅在backend 为vlm-http-client 时可填写',
        accessMode: 'MinerU 接入模式',
        accessModeSelfHosted: '自建 MinerU 服务',
        accessModeOfficialV4: 'MinerU 官方 v4 API',
        selectAccessMode: '选择接入模式',
        apiserver: 'MinerU API服务器配置',
        outputDir: 'MinerU输出目录路径',
        backend: 'MinerU处理后端类型',
        serverUrl: 'MinerU服务器URL地址',
        officialBaseUrl: '官方 API Base URL',
        officialToken: '官方 API Token',
        officialModelVersion: '官方模型版本',
        selectModelVersion: '选择模型版本',
        officialPollInterval: '轮询间隔（秒）',
        officialPollTimeout: '轮询超时（秒）',
