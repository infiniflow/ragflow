...
**重要规则:**
  ...
  - **始终考虑**整个对话历史。`,
      ...
      maxTokens: '上下文长度',
      maxTokensMessage: '上下文长度是必填项',
      maxTokensTip: `模型的最大上下文大小；无效或不正确的值会导致错误。默认值为 512。`,
      maxTokensInvalidMessage: '请输入有效的上下文长度。',
      maxTokensMinMessage: '上下文长度不能小于 0。',
      thinking: '思考中...',
      thinkingMode: '思考',
      thought: '思考完成',
...
示例：general/v2/`,
      ...
      modelMaxTokensMessage: '上下文长度必须为数字',
      modelMaxTokensMinMessage: '上下文长度不能小于 0',
    },
