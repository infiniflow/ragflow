...
**重要规则:**
  ...
  - **始终考虑**整个对话历史。`,
      ...
      temporalRetrieval: {
        title: '时间检索',
        description: '使用文档元数据日期对时间敏感检索进行过滤或重排。',
        modeLabel: '时间模式',
        modeTip: '自动模式仅在查询涉及最新或日期信息时应用新鲜度。',
        modeAuto: '自动',
        modeLatest: '最新',
        modeDateRange: '日期范围',
        modeBalanced: '平衡',
        fieldLabel: '时间字段',
        fieldTip: '选择表示发布时间或事件时间的元数据字段。',
        halfLifeLabel: '半衰期（天）',
        halfLifeTip: '新鲜度提升在该天数内衰减一半。',
        detectedFormat: '检测格式：{{format}}',
        parsedRate: '解析率：{{rate}}%',
        dateRange: '范围：{{oldest}} 至 {{newest}}',
        hardFilterSupported: '硬过滤：支持',
        hardFilterUnsupported: '硬过滤：不支持',
        noProfile: '该字段暂无时间画像。',
        profileError: '加载该字段的时间画像失败。',
        unknownFormat: '未知',
      },
      avatarHidden: '隐藏头像',
      locale: '地区',
