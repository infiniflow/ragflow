export default {
  translation: {
    ...
    evaluation: {
      ...
      datasetNamePlaceholder: '例如：客服 FAQ 回归测试',
      name: '名称',
      description: '描述',
      knowledgeBases: '知识库',
      ...
      testCasesDescription:
        '添加问题，以及可选的参考答案或分块 ID，用于计算检索指标。',
      addCase: '添加用例',
      importCsv: '导入 CSV',
      importSuccess: '已导入 {{count}} 条测试用例',
      question: '问题',
      referenceAnswer: '参考答案',
      relevantChunkIds: '相关分块 ID',
      chunkIdsPlaceholder: '逗号分隔的分块 ID（可选）',
      noCases: '暂无测试用例，请添加或导入后再运行评测。',
      runs: '运行记录',
      runsDescription: '针对聊天助手的历史评测运行。',
      noRuns: '暂无运行记录。',
      runEvaluation: '运行评测',
      selectChat: '聊天助手',
      selectChatPlaceholder: '选择聊天助手',
      startRun: '开始运行',
      runStarted: '评测已开始',
      results: '结果',
