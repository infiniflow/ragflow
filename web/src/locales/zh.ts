export default {
  translation: {
    ...
    skills: {
      title: '技能',
      selectHub: '选择一个技能中心开始使用',
      hubPlaceholder: '输入中心名称',
      createHub: '创建技能中心',
      createHubTitle: '创建新技能中心',
      createHubDescription: '创建一个新的中心来组织和管理您的技能。',
      hubName: '技能中心名称',
      hubNamePlaceholder: '例如：my-hub',
      hubNameRequired: '请输入中心名称',
      noHubs: '暂无技能中心，创建您的第一个！',
      enterHub: '进入',
      hubCreated: '技能中心创建成功',
      hubDeleted: '技能中心删除成功',
      fetchError: '获取技能列表失败',
      deleteHubTitle: '删除技能中心',
      deleteHubDescription:
        '确定要删除此技能中心吗？此操作无法撤销，该中心中的所有技能将被永久删除。',
      deleteHubName: '中心名称',
...
[在此处插入文本]`,
    ...
    empty: {
      ...
      skillsTitle: '尚未创建技能中心',
      notFoundSkills: '未查询到技能中心',
      addNow: '立即添加',
    },
