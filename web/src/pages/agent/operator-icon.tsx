...
import CrawlerIcon from '@/assets/svg/crawler.svg';
import DuckIcon from '@/assets/svg/duck.svg';
import GithubIcon from '@/assets/svg/github.svg';
import GoogleScholarIcon from '@/assets/svg/google-scholar.svg';
import GoogleIcon from '@/assets/svg/google.svg';
import PubMedIcon from '@/assets/svg/pubmed.svg';
import SearXNGIcon from '@/assets/svg/searxng.svg';
import TavilyIcon from '@/assets/svg/tavily.svg';
import WenCaiIcon from '@/assets/svg/wencai.svg';
import WikipediaIcon from '@/assets/svg/wikipedia.svg';
import YahooFinanceIcon from '@/assets/svg/yahoo-finance.svg';
