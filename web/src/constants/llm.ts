...
export const IconMap = {
  ...
  HunYuan: 'hunyuan',
  JieKouAI: 'jiekouai',
  'MinerU.Net': 'minerunet',
  Novita: 'novita-ai',
  Nvidia: 'nvidia',
  OrcaRouter: 'orcarouter',
  'PaddleOCR.Net': 'paddleocrnet',
  Qiniu: 'qiniu',
  SiliconFlow: 'siliconflow',
  TokenHub: 'tokenhub',
  Voyage: 'voyage',
...
export const APIMapUrl = {
  ...
  Aliyun: 'https://www.aliyun.com/product/bailian',
  Astraflow: 'https://www.modelverse.cn/',
  ...
  GPUStack: 'https://docs.gpustack.ai/latest/tutorials/how-to-use-in-cli/',
  Gitee: 'https://ai.gitee.com/',
  Google: 'https://ai.google.dev/',
  HuaweiCloud: 'https://www.huaweicloud.com/product/modelarts.html',
  HunYuan: 'https://hunyuan.tencent.com/',
  JieKouAI: 'https://jiekou.ai/',
  LongCat: 'https://longcat.chat/',
  MinerU: 'https://github.com/opendatalab/MinerU',
  'MinerU.Net': 'https://www.mineru.net/',
  Novita: 'https://novita.ai/',
  Nvidia: 'https://www.nvidia.com/en-us/ai/',
  OrcaRouter: 'https://orcarouter.com/',
  'PaddleOCR.Net': 'https://www.paddleocr.net/',
  Qiniu: 'https://www.qiniu.com/',
  SiliconFlow: 'https://cloud.siliconflow.cn/account/ak',
  TokenHub: 'https://tokenhub.com/',
