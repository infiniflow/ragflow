...
<!-- atlas-cloud-start -->
<p align="center">
  <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=ragflow">
    <img src="docs/images/atlas-cloud-logo.png" alt="Atlas Cloud" width="200">
  </a>
</p>

> 🎁 **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=ragflow)** is a full-modal, OpenAI-compatible AI inference platform. RAGFlow can use it as a drop-in chat **model provider** — pick **Atlas** in the model settings and access DeepSeek, Qwen, GLM, Kimi, MiniMax, Claude, GPT, Gemini and more through a single API, no multi-vendor setup. Budget-friendly: [coding plan](https://www.atlascloud.ai/console/coding-plan).

```env
# Base URL is preset to https://api.atlascloud.ai/v1 when you select the "Atlas" provider.
ATLAS_API_KEY=<atlascloud-api-key>
# A good default reasoning model:
ATLAS_MODEL=deepseek-ai/deepseek-v4-pro
```

`deepseek-ai/deepseek-v4-pro` is a reasoning model — give it enough `max_tokens` (>= 512), otherwise the response may be truncated with empty content.
