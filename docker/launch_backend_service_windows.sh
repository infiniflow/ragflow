...
# Skip jemalloc on Windows (not needed for development)
echo "Running on Windows - skipping jemalloc"
...
# Function to execute task_executor with retry logic (WITHOUT jemalloc)
task_exe(){
    local task_id=$1
    local retry_count=0
