...
class RAGFlowCLI(Cmd):
    def __init__(self):
        ...
        self.account = "support@waqoor.com"
    ...
    def parse_connection_args(self, args: List[str]) -> Dict[str, Any]:
        ...
        parser.add_argument("-u", "--username", default=None, help="Username (email). In admin mode defaults to support@waqoor.com, in user mode required.")
