...
OPENDATALOADER_ENV_KEYS = ["OPENDATALOADER_APISERVER", "OPENDATALOADER_HYBRID", "OPENDATALOADER_IMAGE_OUTPUT", "OPENDATALOADER_SANITIZE"]
OPENDATALOADER_DEFAULT_CONFIG = {
    "OPENDATALOADER_APISERVER": "",
    "OPENDATALOADER_HYBRID": "",
    "OPENDATALOADER_IMAGE_OUTPUT": "",
    "OPENDATALOADER_SANITIZE": "",
}
