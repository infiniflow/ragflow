...
MONKEYOCR_ENV_KEYS = ["MONKEYOCR_APISERVER", "MONKEYOCR_OUTPUT_DIR", "MONKEYOCR_SERVER_URL", "MONKEYOCR_DELETE_OUTPUT"]
MONKEYOCR_DEFAULT_CONFIG = {
    "MONKEYOCR_APISERVER": "",
    "MONKEYOCR_OUTPUT_DIR": "",
    "MONKEYOCR_SERVER_URL": "",
    "MONKEYOCR_DELETE_OUTPUT": 1,
}
