...
GO_ONLY_SKIPS = {
    ...
    "Go validation or response contract does not match the established API contract": {
        ...
        "test_dataset_search_params_and_doc_ids_contract[page_size]",
        "test_dataset_search_params_and_doc_ids_contract[similarity_threshold]",
        "test_dataset_search_params_and_doc_ids_contract[vector_similarity_weight]",
        "test_dataset_search_params_and_doc_ids_contract[top_k]",
