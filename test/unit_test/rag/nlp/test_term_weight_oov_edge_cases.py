...
class TestAlphabeticOovFrequencyEdgeCases:
    ...
    def test_frequency_halves_every_two_letters(self):
        """Longer words get progressively lower frequencies."""
        assert _alphabetic_oov_frequency("laptop") == 150
        assert _alphabetic_oov_frequency("laptops") == 106
        assert _alphabetic_oov_frequency("notebook") == 106
