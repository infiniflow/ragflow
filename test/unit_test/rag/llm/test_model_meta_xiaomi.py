...
def test_xiaomi_model_list_url(provider_base_url, expected_url):
    assert Xiaomi(api_key="test-key", base_url=provider_base_url)._get_model_list_url() == expected_url
