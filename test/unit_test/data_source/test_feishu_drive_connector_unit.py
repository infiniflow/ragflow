...
# lark_oapi emits a pkg_resources UserWarning at import time; suppress it here so
# the repo-wide ``filterwarnings = error`` pytest setting does not fail collection.
...
from common.data_source.config import DocumentSource  # noqa: E402
from common.data_source.exceptions import (  # noqa: E402
