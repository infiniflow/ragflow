...
| MWS                   | [Chat and Embedding](https://mws.ru/docs/cloud-platform/gpt/general/inference-text.html) / [Reranking](https://mws.ru/docs/cloud-platform/gpt/general/inference-rerank.html) |
