...
![add vllm](https://raw.githubusercontent.com/infiniflow/ragflow-docs/main/images/ragflow_gpustack11.png)

select gpustack chat model as default llm model as follow:
![chat](https://raw.githubusercontent.com/infiniflow/ragflow-docs/main/images/ragflow_gpustack22.png)
### 6.3 chat with gpustack chat model
create chat->create conversations-chat as follow:
![chat](https://raw.githubusercontent.com/infiniflow/ragflow-docs/main/images/ragflow_gpustack33.png)
