...
```bash
  pip install vllm 
  ```
### 5.1 DOWNLOAD LLM FORM MODELSCOPE
you can find all models in alibaba modelscope

https://modelscope.cn/models

```bash
  pip install modelscope
  modelscope download --model Qwen/Qwen3-8B-FP8 --local_dir  /data/Qwen3-8
  ```
### 5.2 RUN VLLM WITH BEST PRACTISE
