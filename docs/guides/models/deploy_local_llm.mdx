...
![add vllm](https://github.com/yiminghub2024/ragflow-docs/blob/main/images/ragflow.png)

select vllm chat model as default llm model as follow:
![chat](https://github.com/yiminghub2024/ragflow-docs/blob/main/images/ragflow1.png)
### 5.3 chat with vllm chat model
create chat->create conversations-chat as follow:
![chat](https://github.com/yiminghub2024/ragflow-docs/blob/main/images/ragflow3.png)
