...
:::danger IMPORTANT
In this section, we assume your **Agent** is configured as a planner, with a Tavily tool beneath it.
:::
...
![](https://raw.githubusercontent.com/infiniflow/ragflow-docs/main/images/edit_mcp.jpg)
...
2. Click **built-in** to show the available MCP servers.
...
### 5. View the availabe tools of your MCP server

On the canvas, click the newly-populated Tavily server to view the tools it offers:
