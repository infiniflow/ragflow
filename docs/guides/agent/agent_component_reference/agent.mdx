...
- `task_analysis` prompt block
  ...
  - Reference design: [analyze_task_system.md](https://github.com/yazeedhasan97/MetaGrossAI/blob/main/rag/prompts/analyze_task_system.md) and [analyze_task_user.md](https://github.com/yazeedhasan97/MetaGrossAI/blob/main/rag/prompts/analyze_task_user.md)
...
- `plan_generation` prompt block
  ...
  - Reference design: [next_step.md](https://github.com/yazeedhasan97/MetaGrossAI/blob/main/rag/prompts/next_step.md)
  - Available *only* when this **Agent** component is acting as a planner, with either tools or sub-Agents under it.
  - Input variables:
...
- `reflection` prompt block
  ...
  - Reference design: [reflect.md](https://github.com/yazeedhasan97/MetaGrossAI/blob/main/rag/prompts/reflect.md)
  - Available *only* when this **Agent** component is acting as a planner, with either tools or sub-Agents under it.
  - Input variables:
...
- `citation_guidelines` prompt block
  - Reference design: [citation_prompt.md](https://github.com/yazeedhasan97/MetaGrossAI/blob/main/rag/prompts/citation_prompt.md)
