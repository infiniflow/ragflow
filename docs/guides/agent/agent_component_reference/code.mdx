...
RAGFlow Sandbox is a secure, pluggable code execution backend. It serves as the code executor for the **Code** component. Please follow the [instructions here](https://github.com/yazeedhasan97/MetaGrossAI/tree/main/agent/sandbox) to install RAGFlow Sandbox.
