...
This parameter sets the weight of keyword similarity in the combined similarity score, either used with vector cosine similarity or with reranking score. The total of the two weights must equal 1.0.
...
- If this field is left empty, a combination of weighted keyword similarity and weighted vector cosine similarity will be used for retrieval.
...
:::caution WARNING
Using a rerank model will *significantly* increase the system's response time, worsening user experience.
:::
