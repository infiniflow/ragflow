...
You can take a look at our three-step interpreter agent, where the **Generate** component takes two global variables:
...
5. Click the **Generate** component to display its **Configuration** window.

## Frequently asked questions

### Meaning of `{input}` mean in the prompt of 