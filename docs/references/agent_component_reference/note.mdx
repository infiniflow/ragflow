...
A **note** component allows you to keep design notes, including notes such as what an agent is about, the output of specific component, the rationale of a particular design, or any information that may assist you, your users, or your fellow developers understand the agent.
