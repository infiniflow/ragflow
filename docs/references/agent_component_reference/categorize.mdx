...
A **Categorize** component must have at least one category. This field sets the name of the category. Click **+ Add Item** to include the intended categories. 
...
Description of the user inputs that should fall into this category.  
