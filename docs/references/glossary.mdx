...
This feature is available in the retrieval test and chat assistant settings. See [Run retrieval test](../guides/dataset/retrieval_testing.md) and [Start AI chat](../guides/chat/start_chat.md) for further details.
