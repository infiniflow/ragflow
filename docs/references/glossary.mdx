...
Skills is a knowledge artifact supported by Knowledge Compilation.

It extracts and organizes reusable skill content from existing knowledge, enabling knowledge to be further used in the form of skills.
