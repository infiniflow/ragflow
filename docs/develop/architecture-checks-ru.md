...
Дата: 2026-09-05. Статус: нормативная спецификация для ручного ревью и будущего автоматического контроля. Новые runners и реестры в этом изменении не создаются.
