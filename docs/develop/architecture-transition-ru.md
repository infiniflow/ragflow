...
Дата: 2026-09-05. Статус: T0 реализован для снимка, указанного в [отчёте инвентаризации](t0-provenance-report-ru.md); T1–T7 ещё не выполнены.
...
Созданы реестры происхождения T0 и утилита их снимка. Анализаторы архитектуры/мёртвого кода, новые CI gates и branch protection ещё не внедрены. Проверки поведения приложения не объявляются пройденными по результату инвентаризации.
