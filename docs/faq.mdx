...
RAGFlow implements MinerU PDF document parsing since v0.22.0, where RAGFlow connects to MinerU works only as a remote client to MinerU (>= 2.6.3) and does not install or execute MinerU locally. To use this feature:
