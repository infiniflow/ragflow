...
3. Switch to the latest, officially published release, e.g., `v0.27.0`:
...
4. Update **ragflow/docker/.env**:
   ...
   ```bash
   RAGFLOW_IMAGE=infiniflow/ragflow:v0.27.0
   ```
...
2. Save the Docker image to a **.tar** file.
   ```bash
   docker save -o ragflow.v0.27.0.tar infiniflow/ragflow:v0.27.0
   ```
3. Copy the **.tar** file to the target server.
4. Load the **.tar** file into Docker:
   ```bash
   docker load -i ragflow.v0.27.0.tar
   ```
