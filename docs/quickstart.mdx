...
<details>
  <summary>Expand to show details:</summary>
   ...
   RAGFlow v0.27.1 uses Elasticsearch or [Infinity](https://github.com/infiniflow/infinity) for multiple recall. Setting the value of `vm.max_map_count` correctly is crucial to the proper functioning of the Elasticsearch component.
...
4. Use the pre-built Docker images and start up the server:
   ...
   | ------------------- | --------------- | ------------------------ |
   | v0.27.1             | &approx;2       | Stable release           |
