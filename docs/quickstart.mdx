...
- Python &ge; 3.13;
- [gVisor](https://gvisor.dev/docs/user_guide/install/): Required only if you intend to use the code executor ([sandbox](https://github.com/yazeedhasan97/MetaGrossAI/tree/main/sandbox)) feature of RAGFlow.
...
2. Clone the repo:
   ...
   ```bash
   $ git clone https://github.com/yazeedhasan97/MetaGrossAI.git
   $ cd ragflow/docker
   ```
