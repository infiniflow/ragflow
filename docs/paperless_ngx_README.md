# Paperless-ngx Integration for RAGFlow

Complete guide for integrating Paperless-ngx document management system with RAGFlow.

## Table of Contents

1. [Overview](#overview)
2. [Features](#features)
3. [Ingestion Strategy](#ingestion-strategy-best-practice)
4. [Configuration](#configuration)
5. [Usage](#usage)
6. [UI Integration](#ui-integration)
7. [Example Configurations](#example-configurations)
8. [API Endpoints](#api-endpoints-used)
...
### Example 3: Creating via API (curl)
...
### Example 4: Creating via Python SDK
...
- [ ] OCR content is used when available
- [ ] PDF download fallback works
